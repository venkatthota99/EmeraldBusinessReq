...
public class AphriaProductsPage extends TestBase{
	...
	//Initializing the Page Objects
	   ...
	   public AphriaProductsPage() {
		   PageFactory.initElements(driver, this);
	   }
	 
	 //Actions
	   
	   public AphriaProductsPage Shoppage() throws InterruptedException {
		   Thread.sleep(4000);
		   JavascriptExecutor jss = (JavascriptExecutor)driver;
			jss.executeScript("arguments[0].click();", shopbtn);
			return new AphriaProductsPage();
	   }  
