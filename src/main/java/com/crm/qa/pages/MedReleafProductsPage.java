...
public class MedReleafProductsPage extends TestBase{
	...
	//Initializing the Page Objects
	   ...
	   public MedReleafProductsPage() {
		   PageFactory.initElements(driver, this);
	   }
	 
	 //Actions
	   
	   public MedReleafProductsPage Shoppage() throws InterruptedException {
		   Thread.sleep(4000);
		   JavascriptExecutor jss = (JavascriptExecutor)driver;
			jss.executeScript("arguments[0].click();", shopbtn);
			return new MedReleafProductsPage();
	   }  
