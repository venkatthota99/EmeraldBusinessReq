...
public class SatipharmProductsPage extends TestBase{
	...
	//Initializing the Page Objects
	   ...
	   public SatipharmProductsPage() {
		   PageFactory.initElements(driver, this);
	   }
	 
	 //Actions
	   
	   public SatipharmProductsPage Shoppage() throws InterruptedException {
		   Thread.sleep(4000);
		   JavascriptExecutor jss = (JavascriptExecutor)driver;
			jss.executeScript("arguments[0].click();", shopbtn);
			return new SatipharmProductsPage();
	   }  
