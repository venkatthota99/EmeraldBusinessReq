...
public class FlowrRxProductsPage extends TestBase{
	...
	//Initializing the Page Objects
	   ...
	   public FlowrRxProductsPage() {
		   PageFactory.initElements(driver, this);
	   }
	 
	 //Actions
	   
	   public FlowrRxProductsPage Shoppage() throws InterruptedException {
		   Thread.sleep(4000);
		   JavascriptExecutor jss = (JavascriptExecutor)driver;
			jss.executeScript("arguments[0].click();", shopbtn);
			return new FlowrRxProductsPage();
	   }  
