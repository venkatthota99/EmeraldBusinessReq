...
public class StarseedProductsPage extends TestBase{
	...
	//Initializing the Page Objects
	   ...
	   public StarseedProductsPage() {
		   PageFactory.initElements(driver, this);
	   }
	 
	 //Actions
	   
	   public StarseedProductsPage Shoppage() throws InterruptedException {
		   Thread.sleep(4000);
		   JavascriptExecutor jss = (JavascriptExecutor)driver;
			jss.executeScript("arguments[0].click();", shopbtn);
			return new StarseedProductsPage();
	   }  
