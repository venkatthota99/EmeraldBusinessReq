...
public class TilrayProductsPage extends TestBase{
	...
	//Initializing the Page Objects
	   ...
	   public TilrayProductsPage() {
		   PageFactory.initElements(driver, this);
	   }
	 
	 //Actions
	   
	   public TilrayProductsPage Shoppage() throws InterruptedException {
		   Thread.sleep(4000);
		   JavascriptExecutor jss = (JavascriptExecutor)driver;
			jss.executeScript("arguments[0].click();", shopbtn);
			return new TilrayProductsPage();
	   }  
